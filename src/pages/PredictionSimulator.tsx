...
import { prepareChartData, calculateStats, validatePredictionData } from '@/utils/stockPredictionUtils';
...
const StockPredictionSimulator: React.FC = () => {
  ...
  const stats = useMemo(() => 
    calculateStats(historicalData, predictionData),
    ...
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        `}>
            ...
            <div className="px-8 py-12">
              <div className="text-center">
                ...
                <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                  {predictionData ? 'Loading Market Data...' : 'Analyzing Market Sentiment...'}
                </h3>
          ...
          {stats && !isLoading && (
            <div className="px-8 pb-6">
              <StatsPanel isDark={isDark} stats={stats} />
            </div>
          )}
