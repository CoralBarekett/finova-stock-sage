  ...
  return (
    <AppLayout>
      <div className="mb-6">
        ...
        <p className="text-white/70">Find and analyze stocks by name or symbol</p>
      </div>
      ...
      <div className="mt-6">
        ...
        {loading ? (
          ...
          <div className="finova-card p-8 text-center">
            <SearchIcon className="w-12 h-12 mx-auto text-white/30" />
            <p className="mt-4 text-white text-lg">No results found</p>
          ...
          <div className="finova-card p-8 text-center">
            <SearchIcon className="w-12 h-12 mx-auto text-finova-primary/70" />
            <p className="mt-4 text-white text-lg">Enter a search term</p>
            <p className="mt-2 text-white/60">
