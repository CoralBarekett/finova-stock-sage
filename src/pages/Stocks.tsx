...
const Stocks: React.FC = () => {
  ...
  return (
    <AppLayout>
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2 text-foreground">Stocks</h1>
      ...
      <div className="mt-6">
        <Tabs defaultValue="popular" value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="bg-secondary">
            <TabsTrigger value="popular" className="text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Popular
            </TabsTrigger>
            <TabsTrigger value="watchlist" className="text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Watchlist
            </TabsTrigger>
          </TabsList>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Array(6).fill(0).map((_, i) => (
                  <div key={i} className="finova-card p-4 animate-pulse">
                    ...
                    <div className="h-8 bg-secondary rounded w-2/3 mt-4"></div>
